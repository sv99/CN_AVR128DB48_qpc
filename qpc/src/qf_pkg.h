...
void QActive_start_(QActive* const me, uint_fast8_t prio, QEvt const** const qSto,
                    uint_fast16_t const qLen, void* const stkSto, uint_fast16_t const stkSize,
...
bool QActive_post_(QActive* const me, QEvt const* const e, uint_fast16_t const margin,
