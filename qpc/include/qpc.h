 ...
 * backwards compatibility. This is the default.@n
 * @n
...
#define QS_BEGIN(rec_, obj_)                                                                     \
    if (((QS_priv_.glbFilter[(uint_fast8_t)(rec_) >> 3U] & (1U << ((uint_fast8_t)(rec_)&7U))) != \
         0U) &&                                                                                  \
        ((QS_priv_.locFilter_AP == (void*)0) || (QS_priv_.locFilter_AP == (obj_)))) {            \
        QS_CRIT_STAT_                                                                            \
        QS_CRIT_E_();                                                                            \
...
/*! @deprecated macro for cooperative "Vanilla" kernel;
