...
/* public: */
static QTimeEvtCtr Philo_getRandom(void);
...
/*.${AOs::Philo::getRandom} ................................................*/
static QTimeEvtCtr Philo_getRandom(void) {
    return BSP_random() % BSP_TICKS_PER_SEC + BSP_TICKS_PER_SEC;
}
...
static QState Philo_thinking(Philo * const me, QEvt const * const e) {
    ...
    switch (e->sig) {
        ...
        case Q_ENTRY_SIG: {
            // THINK_TIME
            QTimeEvtCtr time = Philo_getRandom();
            QTimeEvt_armX(&me->timeEvt, time, 0U);
            status_ = Q_HANDLED();
            break;
        }
