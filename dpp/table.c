...
/* public: */
static void Table_displayPhilStat(uint8_t n, char_t const* stat);
static void Table_displayPaused(uint8_t paused);
...
static QState Table_initial(Table * const me, void const * const par) {
    ...
    for (n = 0U; n < N_PHILO; ++n) {
        me->fork[n] = FREE;
        me->isHungry[n] = 0U;
        Table_displayPhilStat(n, "thinking");
    }
...
static QState Table_serving(Table * const me, QEvt const * const e) {
    ...
    switch (e->sig) {
        ...
        case Q_ENTRY_SIG: {
            ...
            for (n = 0U; n < N_PHILO; ++n) { /* give permissions to eat... */
                    ...
                    && (me->fork[n] == FREE))
                {
                    ...
                    me->isHungry[n] = 0U;
                    Table_displayPhilStat(n, "eating  ");
                }
            }
            status_ = Q_HANDLED();
            break;
        ...
        case HUNGRY_SIG: {
            ...
            Table_displayPhilStat(n, "hungry  ");
            m = LEFT(n);
        ...
        case DONE_SIG: {
            ...
            if ((me->isHungry[m] != 0U) && (me->fork[m] == FREE)) {
                ...
                pe->philoNum = m;
                QF_PUBLISH(&pe->super, &me->super);
                Table_displayPhilStat(m, "eating  ");
            }
...
static QState Table_paused(Table * const me, QEvt const * const e) {
    ...
    switch (e->sig) {
        /*.${AOs::Table::SM::active::paused} */
        case Q_ENTRY_SIG: {
            Table_displayPaused(1U);
            status_ = Q_HANDLED();
            break;
        }
        /*.${AOs::Table::SM::active::paused} */
        case Q_EXIT_SIG: {
            Table_displayPaused(0U);
            status_ = Q_HANDLED();
            break;
        }
